...
class DentalProcedureLine(models.Model):
	...
	service_item_id = fields.Many2one('product.product', 'Procedure Name', domain=[('sale_ok', '=', True)],
	                                  required=False, change_default=True)
	cost = fields.Float(related="service_item_id.list_price", string='Procedure Cost', digits=0)